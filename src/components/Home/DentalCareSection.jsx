      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="relative min-h-[420px] md:min-h-[520px] lg:min-h-[640px] group">
            ...
            <div className={`absolute left-4 right-4 top-6 sm:left-10 sm:right-auto sm:w-[460px] lg:left-12 xl:left-16 lg:top-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="rounded-3xl bg-white/15 backdrop-blur-xl ring-1 ring-white/25 shadow-2xl p-5 sm:p-7">
                ...
                <div className="flex items-start gap-4 group/item hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">Family Friendly</h3>
                    <p className="text-white/90 text-sm leading-6 mt-1">
            ...
            <div className="px-4 py-12 sm:py-14 md:py-16 lg:py-20 lg:px-12 xl:px-16">
              <div className={`transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <h2 className="mt-4 text-4xl sm:text-5xl font-extrabold text-slate-900 leading-tight">
                  Exceptional dental care tailored to <br className="hidden sm:block" />
                ...
                <p className="mt-5 max-w-2xl text-[15.5px] font-semibold text-slate-800">
                  We take the time to understand your individual needs and goals, creating
                  customized treatment plans to help you achieve optimal oral health.
                </p>

                <p className="mt-4 max-w-2xl text-[15.5px] leading-7 text-slate-600">
                  We believe that your dental experience should be more than just a routine
                  visit. Our goal is to provide comprehensive, personalized care in a
                  welcoming environment, where your comfort and well-being come first.
                </p>
              </div>

              {/* Stats with animated counters */}
              <div className={`mt-10 grid grid-cols-1 divide-y divide-slate-200 sm:grid-cols-3 sm:divide-y-0 sm:divide-x transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                ...
                <div className="py-6 sm:py-0 sm:px-8 group hover:bg-white/50 rounded-lg transition-all duration-300 p-4 -m-4">
                  ...
                  <div className="mt-1 text-slate-700 font-medium">Happy Patients</div>
                </div>
                <div className="py-6 sm:py-0 sm:px-8 group hover:bg-white/50 rounded-lg transition-all duration-300 p-4 -m-4">
              ...
              <div className={`mt-12 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <button className="group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-cyan-700 px-8 py-4 font-semibold text-white transition-all duration-300 hover:bg-cyan-800 hover:shadow-lg hover:shadow-cyan-700/30">
                  <span className="relative">Schedule Your Appointment</span>
